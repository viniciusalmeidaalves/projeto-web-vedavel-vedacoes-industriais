...
<head>
    ...
    <title>Vedavel - Catalogo</title>
    <meta name="description" content="Confira nossos catálogos completos de vedações industriais, incluindo produtos específicos, retentores e muito mais.">
    <meta name="keywords" content="catálogo de vedações, catálogo industrial, catálogo de produtos, catálogo de retentores, catálogo de anéis o-ring, catálogo de gaxetas, catálogo Vedavel, vedações industriais, produtos industriais, soluções de vedação, catálogo PDF, catálogo online, catálogo de juntas, catálogo de elementos elásticos, catálogo de acoplamentos, catálogo de borrachas, catálogo técnico, catálogo para manutenção, catálogo para máquinas, catálogo para equipamentos">
...
<section id="catalogo2" class="catalogo2-section">
    <div class="container">
      <ul class="catalogo2-lista">
        <li class="catalogo2-item">
          <h3>Catálogo de Vedações Industriais - Geral</h3>
          <p>Descrição breve deste catálogo, destacando os tipos de vedações que ele cobre.</p>
          <a href="#catalogo-vedacoes-geral.pdf" target="_blank" class="btn-abrir-catalogo2">Abrir Catálogo</a>
        </li>
        <li class="catalogo2-item">
          <h3>Catálogo de Produtos Específicos</h3>
          <p>Descrição breve deste catálogo, focando em produtos específicos ou linhas especiais.</p>
          <a href="#catalogo-produtos-especificos.pdf" target="_blank" class="btn-abrir-catalogo2">Abrir Catálogo</a>
        </li>
        <li class="catalogo2-item">
          <h3>Catálogo de Retentores</h3>
          <p>Descrição detalhada dos retentores disponíveis, com especificações técnicas.</p>
          <a href="#catalogo-retentores.pdf" target="_blank" class="btn-abrir-catalogo2">Abrir Catálogo</a>
        </li>
        </ul>
    </div>
  </section>
